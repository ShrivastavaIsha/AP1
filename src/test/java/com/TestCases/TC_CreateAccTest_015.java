...
public class TC_CreateAccTest_015 extends BaseClass
{
	@Test
	public void loginTest() throws IOException, InterruptedException
	{
		...
		cap.setPass(password2);
		logger.info("Incorrect format password set");
		cap.setConfirmPass(password2);
		...
		if(driver.getTitle().endsWith(URL5))
		{
			...
			logger.info("Create account test case 15 is failed");
		}
		...
		else
		{
			...
			logger.info("Create account test case 15 is passed");
		}
	}
