...
public class TC_CreateAccTest_016 extends BaseClass
{
	...
	public void loginTest() throws IOException, InterruptedException
	{
		...
		cap.setPass(password3);
		logger.info("Incorrect format password set");
		cap.setConfirmPass(password3);
		...
		if(driver.getTitle().endsWith(URL5))
		{
			...
			logger.info("Create account test case 16 is failed");
		}
		...
		else
		{
			...
			logger.info("Create account test case 16 is passed");
		}
	}
