...
public class TC_HomePageTest_023 extends BaseClass
{
		...
		public void homePageTest() throws IOException, InterruptedException
		{
			...
			if(driver.getTitle().endsWith(URL7))
			{
				...
				logger.info("Home page test case 23 is failed");
			...
			else
			{
				...
				logger.info("Home page test case 23 is passed");
