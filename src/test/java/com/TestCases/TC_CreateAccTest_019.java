...
public class TC_CreateAccTest_019 extends BaseClass
{
	@Test
	public void loginTest() throws IOException, InterruptedException
	{
		...
		cap.setPass(password6);
		logger.info("Incorrect format password set");
		cap.setConfirmPass(password6);
		...
		if(driver.getTitle().endsWith(URL5))
		{
			...
			logger.info("Create account test case 19 is failed");
		}
		...
		else
		{
			...
			logger.info("Create account test case 19 is passed");
		}
	}
