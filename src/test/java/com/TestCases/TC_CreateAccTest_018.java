...
public class TC_CreateAccTest_018 extends BaseClass
{
	...
	public void loginTest() throws IOException, InterruptedException
	{
		...
		cap.setPass(password5);
		logger.info("Incorrect format password set");
		cap.setConfirmPass(password5);
		...
		if(driver.getTitle().endsWith(URL5))
		{
			...
			logger.info("Create account test case 18 is failed");
		}
		...
		else
		{
			...
			logger.info("Create account test case 18 is passed");
		}
	}
