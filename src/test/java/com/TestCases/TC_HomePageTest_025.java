...
public class TC_HomePageTest_025 extends BaseClass
{
	@Test
	public void homePageTest() throws IOException, InterruptedException
	{
	    ...
	    hp.colorTeesOrange();
		logger.info("Orange color tees selected");
		...
		if(driver.getTitle().endsWith(URL6))
		{
			...
			logger.info("Home page test case 25 is failed");
		}
		...
		else
		{
			...
			logger.info("Home page test case 25 is passed");
		}
