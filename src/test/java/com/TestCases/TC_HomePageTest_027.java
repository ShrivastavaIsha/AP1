...
public class TC_HomePageTest_027 extends BaseClass
{
	@Test
	public void homePageTest() throws IOException, InterruptedException
	{
		...
		if(driver.getTitle().endsWith(URL6))
		{
			...
			logger.info("Home page test case 27 is failed");
		}
		...
		else
		{
			...
			logger.info("Home page test case 27 is passed");
		}
